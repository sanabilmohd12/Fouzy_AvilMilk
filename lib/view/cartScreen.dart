                                ...
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    if (form!.validate()) {
                                      ...
                                      value.getitemsid();
                                      callNext(context, Printerscreen(name: "",datetime: "",deskno: "",itemslist: [],ordertype: "",));
                          ...
                          children: [
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // FutureBuilder<File>(
                                    //   future: DefaultCacheManager().getSingleFile(items.itemsphoto),
                                    ...
                                    // ),
                                    items.itemsphoto!=""?
                                    Image.network(items.itemsphoto,scale: 5,):Image.asset("assets/Sundae (1).png",),
                                    Align(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  IconButton(
                                      onPressed: () => value.countDecrement(index, items.id),
                                      icon: const Icon(
                                        CustomIcons.minus_circle,
                                        color: Colors.red,
                                      )),
                                  Center(
                                    child: text(items.count.toString(), FontWeight.w400, cgreen, 20),
                                  ),
                                  IconButton(
                                    onPressed: () => value.countIncrement(index, items.id),
                                    icon: Icon(
