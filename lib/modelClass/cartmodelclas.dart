...
class CartItemsDetails{
  ...
  String totalprice ;
  int count;
  CartItemsDetails(this.id,this.itemcategory,this.itemsid,this.addedtime,this.totalprice,this.itemsname,this.itemsphoto,
      this.itemsprice,this.itemsqty,this.count);
